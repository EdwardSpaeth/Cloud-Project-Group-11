...
\begin{itemize}
    ...
    \item \textbf{Project Deadline:} The \textbf{final report, presentation, and demo must be submitted by 28.02.2025}.
    \item \textbf{Team Contribution Evaluation:} Each member’s work is tracked through \textbf{GitHub commits}.
\end{itemize}
